...
function lyric_shonichi() {
  document.getElementById("lyric").innerHTML = `xxxxzjzx xnbBbj ccBx
xxxxzb jjjjhghhjj
xxxxzjzx xnbBbjccBx
xxxxzb zjhghhggg
...
function lyric_kimiwa() {
  document.getElementById("lyric").innerHTML = `xxxxzjjz xxxczjh
zzzzjhjzzxzjjhg
